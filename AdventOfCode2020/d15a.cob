       ...
       WORKING-STORAGE SECTION.
         ...
         01 N PIC 9.
         01 N1 PIC 9.
         01 WS-NUMBERS OCCURS 9999 TIMES.
           05 NUM-LAST PIC 9(6) VALUE 0.
           05 NUM-PREV PIC 9(6) VALUE 0.
         01 LAST-NUM PIC 9(6) VALUE 0.
         01 SPOKEN-NUM PIC 9(6) VALUE 0.
         01 LAST-I PIC 9(6) VALUE 0.
         01 PREV-I PIC 9(6) VALUE 0.
      ...
      *2,15,0,9,1,20
       ...
       SPEAK-NUMBERS.
           ...
           COMPUTE N1 = N + 1.
           PERFORM VARYING I FROM N1 BY 1 UNTIL I > 2020
