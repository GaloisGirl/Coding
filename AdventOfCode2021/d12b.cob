       ...
       WORKING-STORAGE SECTION.
         ...
         01 WS-QUEUE OCCURS 999999 TIMES.
           05 Q-LEN PIC 9(3).
           05 Q-DOUBLE PIC X(5).
         ...
         77 VISITED PIC 99 VALUE 0.
         77 LOWERCASE PIC 9 VALUE 0.
             ...
             PERFORM VARYING I FROM 1 BY 1 UNTIL I > N
               IF V1(I) = NODE1 THEN
                 ...
                 ELSE
                   ...
                   IF LOWERCASE = 0 THEN
                     ADD 1 TO Q2
                     MOVE Q-DOUBLE(Q1) TO Q-DOUBLE(Q2)
                   ...
                   ELSE                     
                     IF VISITED = 0 THEN
                       ...
                       MOVE NODE2 TO Q-V(Q2, LEN + 1)
                     END-IF  
                     IF VISITED = 1 AND Q-DOUBLE(Q1) = ' ' 
                      AND NODE2 <> 'start' THEN
                       ADD 1 TO Q2
                       MOVE NODE2 TO Q-DOUBLE(Q2)
                       COMPUTE Q-LEN(Q2) = LEN + 1
                       PERFORM VARYING J FROM 1 BY 1 UNTIL J > LEN
                         MOVE Q-V(Q1, J) TO Q-V(Q2, J)
                       END-PERFORM
